...
ggplot(data = mpg, aes(x = cty, y = hwy)) + geom_jitter() + theme_minimal() + ylim(0,50) + xlim(50,0)
...
ggplot(data = mpg, aes(x = cty, y = hwy, shape=as.factor(manufacturer))) + geom_jitter() + theme_minimal()
...
# facet wrap shows a lot of plots together ?
